...
function [Int] = getSpectraASEQ(numOfScans,numOfBlankScans,exposureTime)
...
x = textread('Y 2793.txt');                                                                %% reads calibrationFile.text, remove first line of the original Calibration file and convert to .txt
waveLength = x(2:3654);                                                                             %% crops the calibration file to needed data. Units: [nm]
                                                                                                                                                                                           
[connection,deviceContextPtr]=calllib('spectrlib_core_shared','connectToDeviceByIndex',Index,2);    %% connect To device
